...
<body onunload="GUnload()">
  ...
  <div id="infoPanel">
    ...
    <!-- <select name="TypeID" id="TypeID" onchange="handleMarkerIcon(this)">
      <option value="1" selected>Sekolah
      <option value="2">SPBU</option>
...
<tr>
			...
			<td width="677">
		<input class="inp" name="Latitude" id="Latitude" type=text size=20><br/>
...
<tr>
			...
			<td width="677">
		<input class="inp" name="Longitude" id="Longitude" type=text size=20><br/>
...
<tr>
			...
			<td width="677">
		<input class="inp" name="ZoomLevel" id="ZoomLevel" type=text size=1><br/>
...
<tr>
			...
			<td width="677">
			<input class="inp" name="Title" id="Title" type=text size=42><br/>
...
<tr>
			...
			<td width="677">
			<textarea class="inp" name="" rows=8 cols=33 id="TextHTML"></textarea><br/>
...
<tr>
			...
			<td width="677">
		<textarea class="inp"  rows=2 cols=33 name="Address" id="Address" type=text></textarea><br/>
		
</tr>

<tr>
		<td colspan="2"><center> <input class="inp" type="button"  value="Add" onclick="simpanMarker()"></td>
...
<tr>
	<tr align="right" bgcolor="#D5EDB3">
		<td><a href="logout.php"><center>Exit</td>
</tr>
</body>
</html>