...
<title>Optimized Directions</title>
...
<script type="text/javascript">
  ...
  function initialize() {
    ...
    var Bangkinang = new google.maps.LatLng(0.3326417,101.02427310000007);
    var myOptions = {
      zoom:13,
...
<body onload="initialize()" style="font-family: sans-serif;">
  ...
  <div style="position:relative; border: 1px; width: 610px; height: 400px;">
    <div id="map_canvas" style="border: 1px solid black; position:absolute; width:900px; height:650px"></div>
