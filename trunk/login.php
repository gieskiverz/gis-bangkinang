<html>
    ...
    <div align="left" class="homepage_innerdiv">
        <div class="intro-text">
            <h1 style="text-shadow: white 0em 0em 0em; "><center>Geographic Information System</center> </h1>
			...
			Google menawarkan peta yang dapat diseret dan gambar satelit untuk seluruh dunia dan baru-baru ini, Bulan, dan juga menawarkan perencana rute dan pencari letak bisnis di U.S., Kanada, Jepang, Hong Kong, Cina, UK, Irlandia (hanya pusat kota) dan beberapa bagian Eropa <a href="http://maps.google.com" target="_blank">(http://id.wikipedia.org/wiki/Google_Maps) </a>.
            <!-- With jejaring sosial users can communicate using quick status updates of 160 characters or less. This free flowing dialogue lets you send messages, pictures and video to anyone! It`s also easy to find and connect with other people for private threads and to keep track of their updates. All this and more in a simple interface.  -->       </div>
        <div id="registration" style="">
            <form method="post" action="loginsubmit.php">
                <div style="margin: 0px 0px 5px 5px;"><b>Sign account</b></div>
...
<div class="golden_line"></div>
			...
			<div id="subfooter">
				<div id="sfleft">
					<b><a href="http://bangkinag-maps.co.cc" target="_blank">Sistem Informasi Geografis Fasilitas Umum Kota Bangkinang</a></b>
