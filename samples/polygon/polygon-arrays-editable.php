...
<script type="text/javascript">
  ...
  function showArrays(event) {
    ...
    contentString += "Clicked Location: <br />Latitude:<INPUT TYPE=\"text\" ID=\"Latitude\" NAME=\"Latitude\" VALUE=\"" 
      + event.latLng.lat() + "\">,<br />Longitude:<INPUT TYPE=\"text\" ID=\"Longitude\" NAME=\"Longitude\" VALUE=\"" + event.latLng.lng() + "\"><br />";
