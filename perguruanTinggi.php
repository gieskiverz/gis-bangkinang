...
<title>View Perguruan Tinggi</title>
...
<meta name="viewport" content="initial-scale=1.0, user-scalable=no" />
    ...
    if (GBrowserIsCompatible()) {
	 ...
	 var map = new GMap2(document.getElementById("map"));
	   map.setCenter(new GLatLng(0.33744813637441384,101.02465933809822), 15);
	...
	$sql = "SELECT * FROM `marker` INNER JOIN `icon` ON marker.IconID = icon.IconID where marker.IconID ='6' ";
